  ...
  return (
    <div className="pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto bg-background min-h-screen">
      ...
      <div className="space-y-12 text-slate-600 dark:text-slate-400 leading-relaxed">
        <section>
          <h2 className="text-2xl font-bold text-text dark:text-white mb-4">1. Protection des données</h2>
          <p>
            {isFr
        ...
        <section>
          <h2 className="text-2xl font-bold text-text dark:text-white mb-4">2. Collecte des données</h2>
          <p className="mb-4">
        ...
        <section>
          <h2 className="text-2xl font-bold text-text dark:text-white mb-4">3. Utilisation des données</h2>
          <p>
            {isFr
        ...
        <section>
          <h2 className="text-2xl font-bold text-text dark:text-white mb-4">4. Vos droits</h2>
          <p>
            {isFr
