        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          <div className="flex-1 text-center lg:text-left">
            <Reveal delay={0} scale>
              <div className="inline-flex items-center gap-3 px-5 py-2.5 rounded-full bg-white dark:bg-slate-900 border border-gray-ui dark:border-slate-800 shadow-sm mb-10 group max-w-lg lg:max-w-none">
                <span className="flex-shrink-0 flex items-center justify-center w-6 h-6 rounded-full bg-primary text-white">
                  <Sparkles size={12} className="animate-spin-slow" />
                </span>
                <span className="text-[10px] md:text-[11px] font-bold text-slate-600 dark:text-slate-300 tracking-tight lg:tracking-[0.05em]">
                  {t.badge}
                </span>
              </div>
            </Reveal>
            ...
            <Reveal delay={150} direction="up">
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif font-black tracking-tight text-[#111111] dark:text-white mb-10 leading-[1.1]">
                {t.title} <br />
            ...
            <Reveal delay={300} direction="up">
              <p className="text-lg md:text-xl text-slate-500 dark:text-slate-400 mb-12 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-light">
                {t.description}
              </p>
            </Reveal>
            ...
            <Reveal delay={450}>
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 mb-16">
                <Button size="lg" className="w-full sm:w-auto min-w-[200px] gap-3 h-14" href="https://apps.apple.com" target="_blank">
                ...
                <Button size="lg" variant="white" className="w-full sm:w-auto min-w-[200px] gap-3 h-14 border-2 border-gray-ui dark:border-slate-700 dark:bg-slate-900/50 dark:text-white" href="https://play.google.com" target="_blank">
