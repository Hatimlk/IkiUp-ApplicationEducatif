              ...
              <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                ...
                <div className="text-left">
                  ...
                  <p className="text-base md:text-lg text-slate-400 mb-10 font-normal leading-relaxed max-w-xl">
                    IkiUp propose différentes formules pour les familles et les établissements. Les détails des offres sont accessibles directement dans l’application.
                  </p>
                ...
                <div className="lg:pl-12 lg:border-l lg:border-white/10">
                  <div className="bg-white/5 backdrop-blur-md rounded-[2.5rem] p-8 md:p-10 border border-white/10">
                    ...
                    <p className="text-slate-400 mb-8 font-normal leading-relaxed">
                      Parent, élève ou établissement scolaire : contactez-nous pour découvrir comment IkiUp peut vous accompagner.
                    </p>
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <div className="text-[9px] font-bold uppercase tracking-widest text-slate-400 group-hover:text-white/80">Nous écrire</div>
                          <div className="text-base font-bold text-white">contact@ikiup.com</div>
                        </div>
                      </div>
