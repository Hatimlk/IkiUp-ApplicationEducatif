        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12 md:gap-8 relative z-10">
          ...
          <Reveal delay={0} direction="right" className="flex-1 w-full">
            <div className="relative group">
              ...
              <div className="relative p-8 rounded-[2rem] bg-white dark:bg-slate-950 border-2 border-slate-100 dark:border-slate-800 shadow-sm transition-all hover:border-red-100 dark:hover:border-red-900 overflow-hidden">
                ...
                <h3 className="text-xl font-serif font-bold text-slate-900 dark:text-white mb-3">La dispersion</h3>
          ...
          <Reveal delay={200} direction="left" className="flex-1 w-full">
            <div className="relative group">
              ...
              <div className="relative p-8 rounded-[2rem] bg-white dark:bg-slate-950 border-2 border-slate-100 dark:border-slate-800 shadow-xl shadow-slate-200/50 dark:shadow-none transition-all hover:border-emerald-100 dark:hover:border-emerald-900 overflow-hidden">
                ...
                <h3 className="text-xl font-serif font-bold text-slate-900 dark:text-white mb-3">La concentration</h3>
                <p className="text-slate-600 dark:text-slate-400 font-medium leading-relaxed">
