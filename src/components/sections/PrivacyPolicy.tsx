                ...
                <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    <Reveal>
                        <div className="text-center mb-16">
                            ...
                            <h1 className="text-3xl md:text-5xl font-serif font-black text-text mb-4">
                                {t.title}
                            </h1>
                            <p className="text-lg text-slate-600 font-normal max-w-xl mx-auto">
                                {t.subtitle}
                            </p>
                    ...
                    <div className="space-y-6">
                        {t.sections.map((section: { title: string; content: string }, index: number) => (
                            <Reveal key={index} delay={index * 80} direction="up">
                                <div className="group bg-white border border-slate-200/80 rounded-2xl p-6 sm:p-8 hover:shadow-lg hover:shadow-slate-200/30 transition-all duration-300 hover:-translate-y-0.5">
